...
int main( void )
{
	...
	bool res = loadAssImp("cat.obj", indices, indexed_vertices, indexed_uvs, indexed_normals);
//    bool res = loadAssImp("box1.obj", indices, indexed_vertices, indexed_uvs, indexed_normals);
